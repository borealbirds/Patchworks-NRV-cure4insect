...
for (SPP in names){
  ...
  xyreduced@data$Abund<-ifelse(fma.0C.red.u$Abund>quantile(fma.0C.red.u$Abund,0.99,na.rm=TRUE),
                               quantile(fma.0C.red.u$Abund,0.99,na.rm=TRUE),
                               fma.0C.red.u$Abund)
...
+datum=NAD83 +units=m +no_defs +ellps=GRS80 +towgs84=0,0,0")
  ...
  xyreduced@data$Abund<-ifelse(fma.50C.red.u$Abund>quantile(fma.50C.red.u$Abund,0.99,na.rm=TRUE),
                               quantile(fma.50C.red.u$Abund,0.99,na.rm=TRUE),
                               fma.50C.red.u$Abund)
...
+datum=NAD83 +units=m +no_defs +ellps=GRS80 +towgs84=0,0,0")
  ...
  xyreduced@data$Abund<-ifelse(fma.0E.red.u$Abund>quantile(fma.0E.red.u$Abund,0.99,na.rm=TRUE),
                               quantile(fma.0E.red.u$Abund,0.99,na.rm=TRUE),
                               fma.0E.red.u$Abund)
...
+datum=NAD83 +units=m +no_defs +ellps=GRS80 +towgs84=0,0,0")
  ...
  xyreduced@data$Abund<-ifelse(fma.50E.red.u$Abund>quantile(fma.50E.red.u$Abund,0.99,na.rm=TRUE),
                               quantile(fma.50E.red.u$Abund,0.99,na.rm=TRUE),
                               fma.50E.red.u$Abund)
...
+datum=NAD83 +units=m +no_defs +ellps=GRS80 +towgs84=0,0,0")
  ...
  tiff(paste0("3_output/maps/whole fma/",SPP,"PatchworksDensityMaps.tiff"), units="in", width=15, height=9, res=300)
